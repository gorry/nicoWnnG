...
public class ClearUserDictionaryDialogPreferenceJAJP extends DialogPreference {
	 ...
	 */
	public ClearUserDictionaryDialogPreferenceJAJP(final Context context, final AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	}
	 ...
	 * @param context   The context
	 */
	public ClearUserDictionaryDialogPreferenceJAJP(final Context context) {
		this(context, null);
	}
