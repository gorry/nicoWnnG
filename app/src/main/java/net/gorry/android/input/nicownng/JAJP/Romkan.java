...
import net.gorry.android.input.nicownng.LetterConverter;
import net.gorry.android.input.nicownng.StrSegment;
...
public class Romkan implements LetterConverter {
	...
	private static final HashMap<String, String> romkanTable = new HashMap<String, String>() {{
		...
		put("vu", "\u3094");        put("va", "\u3094\u3041");      put("vi", "\u3094\u3043");
		put("vyi", "\u3094\u3043");     put("ve", "\u3094\u3047");      put("vye", "\u3094\u3047");
		put("vo", "\u3094\u3049");      put("vya", "\u3094\u3083");     put("vyu", "\u3094\u3085");
		put("vyo", "\u3094\u3087");
	...
	private static final HashMap<String, String> romkanTable2 = new HashMap<String, String>() {{
		put("n", "\u3093");
	}};
	...
	public boolean convert(final ComposingText text) {
		return convertCore(text, romkanTable);
	}

	public boolean convert2(final ComposingText text) {
		return convertCore(text, romkanTable2);
	}

	private boolean convertCore(final ComposingText text, final HashMap<String, String> table) {
		final int cursor = text.getCursor(1);

		if (cursor <= 0) {
			return false;
		}

		final StrSegment[] str = new StrSegment[3];
		int start = 2;
		...
		while (start < 3) {
			...
			final boolean upper = Character.isUpperCase(key.charAt(key.length() - 1));
