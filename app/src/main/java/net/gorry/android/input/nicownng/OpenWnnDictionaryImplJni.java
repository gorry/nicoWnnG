...
public class OpenWnnDictionaryImplJni {
     ...
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see net.gorry.android.input.nicownng.WnnDictionary#APPROX_PATTERN_JAJP_12KEY_NORMAL
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the search operation (for JNI native library)
     *
     * @see net.gorry.android.input.nicownng.WnnDictionary#SEARCH_LINK
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
     ...
     *
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#getNextWord
     * @param work      The internal work area
     ...
     * @param type          The type of a part of speech
     * @return              0 if type is not found; <0 if an error occur; >0 The part of speech
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_V1
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_V2
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_V3
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_BUNTOU
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_TANKANJI
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_SUUJI
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_MEISI
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_JINMEI
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_CHIMEI
     * @see net.gorry.android.input.nicownng.OpenWnnDictionaryImplJni#POS_TYPE_KIGOU
     */
    ...
    /**
     * Chmod Learning Dictionary file(*.dic) to 600. 
     *
     * @param dicFilePath   The path of the learning dictionary file(*.dic)
     * @return              Success=1, Fail=0
     */
    public static final native int setDicFilePermission600( String dicFilePath );

    /**
     * Rename Learning Dictionary file(*.dic) to new position. 
     *
     * @param dicOldFilePath   The path of the learning dictionary file(*.dic)
     * @param dicNewFilePath   The path of the learning dictionary file(*.dic)
     * @return                 Success=1, Fail=0
     */
    public static final native int moveOldDicFile( String dicOldFilePath, String dicNewFilePath );
